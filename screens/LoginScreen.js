    ...
    return (
        <KeyboardAvoidingView style={styles.mainContainer}>
            ...
            <View style={styles.contentContainer}>
                ...
                <TouchableOpacity style={[styles.submitButton, {marginBottom:10}]} onPress={handleSignIn}>
                    <Text style={styles.submitButtonText}>Login</Text>
                </TouchableOpacity>
                <View style={{paddingHorizontal:60, marginTop:20,flexDirection:'row', justifyContent:'center'}}>
                    <View style={styles.line}></View>
                    <Text style={{fontSize:18}}>Or</Text>
                    <View style={styles.line}></View>
                </View>
                <View style={{flex:1, flexDirection:'row', justifyContent:'space-evenly', marginTop:20}}>
                    <TouchableOpacity><Image source={require('../assets/icons/google.png')}/></TouchableOpacity>
                    <TouchableOpacity><Image source={require('../assets/icons/apple.png')}/></TouchableOpacity>
                    <TouchableOpacity><Image source={require('../assets/icons/facebook.png')}/></TouchableOpacity>
                </View>
            </View>
